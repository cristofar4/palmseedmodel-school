  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onClose}
        className="fixed right-5 top-5 z-[95] flex h-11 w-11 items-center justify-center rounded-full border border-white/20 text-warm transition hover:border-accent hover:text-accent"
